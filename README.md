...
| `line_text_color`              |       ColorType       |             `auto`             |                                          black                                           | Color of text in line. Automatic text color is calculated using a standard luminance formula based on human perception.                    |
| `line_text_overflow`           |   TextOverflowType    |           `tooltip`            |                                           fade                                           | What happens when the text in the line overflows [see examples](#overflow)                                                                 |
| `overflow_direction`           | OverflowDirectionType |            `right`             |                                           left                                           | Direction text slides or disappears to when overflowing [see examples](#overflow)                                                          |
...
| `untracked_legend_label`       |        string         |    `Untracked consumption`     |                                        Untracked                                         | The label for the untracked legend. (default is translated). Supports [templating](#templating).                                           |
...
| `unit`               |    string     |  *entity unit*   |                                            kW                                            | String that is added to the end of entity state. Supports [templating](#templating).                                                                 |
...
| `line_text_color`    |   ColorType   |      *main*      |                                          black                                           | Color of text in line. Automatic text color is calculated using a standard luminance formula based on human perception.                              |
| `legend_indicator`   | IndicatorType | `icon-fallback`  |                                          circle                                          | What indicator will be left of the text in the legend.                                                                                               |
| `legend_text_color`  |   ColorType   |      *main*      |                                          white                                           | Color of the legend text.                                                                                                                            |
| `tap_action`         | Action Config |   *more-info*    | [Configuration](https://www.home-assistant.io/lovelace/actions/#configuration-variables) | Single tap action for item.                                                                                                                          |
| `hold_action`        | Action Config |   *more-info*    | [Configuration](https://www.home-assistant.io/lovelace/actions/#configuration-variables) | Hold action for item.                                                                                                                                |
| `double_tap_action`  | Action Config |      *none*      | [Configuration](https://www.home-assistant.io/lovelace/actions/#configuration-variables) | Double tap action for item.                                                                                                                          |
<p>
...
| `icon`         | Specified in config.                                                                              | mdi:flash |
